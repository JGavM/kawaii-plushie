...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppManagementManagementComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ManagementComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 7,
      consts: [["role", "banner", 1, "toolbar"], ["height", "60px", "alt", "Logo", "src", "assets/images/cutie_plushie_logo_header.png", 3, "click"], ["class", "toolbar-options sales", 3, "click", 4, "ngIf"], ["class", "toolbar-options products", 3, "click", 4, "ngIf"], ["class", "toolbar-options suppliers", 3, "click", 4, "ngIf"], ["class", "toolbar-options distributors", 3, "click", 4, "ngIf"], ["class", "toolbar-options register", 3, "click", 4, "ngIf"], ["class", "toolbar-options passwordreset", 3, "click", 4, "ngIf"], ["class", "toolbar-options logout", 3, "click", 4, "ngIf"], [1, "toolbar-options", "sales", 3, "click"], [1, "sales"], [1, "toolbar-options", "products", 3, "click"], [1, "products"], [1, "toolbar-options", "suppliers", 3, "click"], [1, "suppliers"], [1, "toolbar-options", "distributors", 3, "click"], [1, "distributors"], [1, "toolbar-options", "register", 3, "click"], [1, "register"], [1, "toolbar-options", "passwordreset", 3, "click"], [1, "passwordreset"], [1, "toolbar-options", "logout", 3, "click"], [1, "logout"]],
